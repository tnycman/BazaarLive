...
const homeCategories = [
  ...
  { id: 'accents', name: 'Accents', count: '6K+' },
  { id: 'bath', name: 'Bath & Bedding', count: '4K+' },
  { id: 'kitchen', name: 'Kitchen & Dining', count: '3K+' },
  { id: 'holiday', name: 'Holiday & Seasonal', count: '2K+' }
];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2" data-testid="text-home-title">
                Home & Garden
              </h1>
              <p className="text-gray-600 dark:text-gray-400" data-testid="text-home-subtitle">
                Transform your space with home decor, furniture, and seasonal items
              </p>
            </div>
