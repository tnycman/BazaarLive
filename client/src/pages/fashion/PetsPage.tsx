...
const petsCategories = [
  { id: 'all', name: 'All Pets', count: '8K+' },
  { id: 'dog', name: 'Dog', count: '4K+' },
  { id: 'cat', name: 'Cat', count: '2.5K+' },
  { id: 'bird', name: 'Bird', count: '800+' },
  { id: 'small-pets', name: 'Small Pets', count: '600+' },
  { id: 'pet-care', name: 'Pet Care', count: '1K+' }
];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2" data-testid="text-pets-title">
                Pet Supplies & Accessories
              </h1>
              <p className="text-gray-600 dark:text-gray-400" data-testid="text-pets-subtitle">
                Everything your furry, feathered, and scaled friends need
              </p>
            </div>
