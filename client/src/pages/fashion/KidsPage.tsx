...
const kidsCategories = [
  { id: 'all', name: 'All Kids', count: '12K+' },
  { id: 'accessories', name: 'Accessories', count: '2K+' },
  { id: 'clothing', name: 'Clothing', count: '6K+' },
  { id: 'shoes', name: 'Shoes', count: '3K+' },
  { id: 'toys', name: 'Toys', count: '4K+' },
  { id: 'trending', name: 'Trending Styles', count: '800+' }
];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2" data-testid="text-kids-title">
                Kids' Fashion & Toys
              </h1>
              <p className="text-gray-600 dark:text-gray-400" data-testid="text-kids-subtitle">
                Discover clothes, shoes, toys and accessories for children of all ages
              </p>
            </div>
