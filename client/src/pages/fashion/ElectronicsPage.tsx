...
const electronicsCategories = [
  { id: 'all', name: 'All Electronics', count: '20K+' },
  { id: 'camera', name: 'Camera & Photo', count: '4K+' },
  { id: 'phones', name: 'Cell Phones', count: '8K+' },
  { id: 'computers', name: 'Computers & Tablets', count: '5K+' },
  { id: 'gaming', name: 'Video Games', count: '3K+' },
  { id: 'wearable', name: 'Wearable Tech', count: '2K+' }
];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2" data-testid="text-electronics-title">
                Electronics & Tech
              </h1>
              <p className="text-gray-600 dark:text-gray-400" data-testid="text-electronics-subtitle">
                Find phones, computers, gaming gear, and the latest tech gadgets
              </p>
            </div>
