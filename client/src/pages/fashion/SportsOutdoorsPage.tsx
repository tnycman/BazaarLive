...
const sportsCategories = [
  { id: 'all', name: 'All Sports', count: '16K+' },
  { id: 'athletic-apparel', name: 'Athletic Apparel', count: '6K+' },
  { id: 'sports-equipment', name: 'Sports Equipment', count: '4K+' },
  { id: 'outdoor-gear', name: 'Outdoor Gear', count: '3K+' },
  { id: 'fitness', name: 'Fitness Equipment', count: '2K+' },
  { id: 'recreational', name: 'Recreational', count: '1K+' }
];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2" data-testid="text-sports-title">
                Sports & Outdoors
              </h1>
              <p className="text-gray-600 dark:text-gray-400" data-testid="text-sports-subtitle">
                Find athletic gear, outdoor equipment, and fitness essentials
              </p>
            </div>
