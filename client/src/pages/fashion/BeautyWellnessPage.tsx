...
const beautyCategories = [
  { id: 'all', name: 'All Beauty', count: '10K+' },
  { id: 'skincare', name: 'Skincare', count: '4K+' },
  { id: 'haircare', name: 'Haircare', count: '2.5K+' },
  { id: 'wellness', name: 'Wellness', count: '2K+' },
  { id: 'tools', name: 'Beauty Tools', count: '1K+' },
  { id: 'fragrance', name: 'Fragrance', count: '1.5K+' }
];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2" data-testid="text-beauty-title">
                Beauty & Wellness
              </h1>
              <p className="text-gray-600 dark:text-gray-400" data-testid="text-beauty-subtitle">
                Discover skincare, haircare, wellness products, and beauty essentials
              </p>
            </div>
