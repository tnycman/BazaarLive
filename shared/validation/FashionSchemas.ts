...
export const ImagesSchema = z.array(z.string().url("Each image must be a valid URL"))
  ...
  .refine(
    ...
    "All images must be valid image URLs (jpg, jpeg, png, webp, gif)"
  )
  .refine(
...
// Style Tags Schema
export const StyleTagsSchema = z.array(
  z.string()
...
export const CurrencySchema = z.string()
  ...
  .refine(currency => ['USD', 'EUR', 'GBP', 'CAD', 'AUD'].includes(currency), 
    "Currency must be one of: USD, EUR, GBP, CAD, AUD")
  .default('USD');

// Fashion Listing Create Schema Base (ZodObject for method chaining)
const FashionListingCreateSchemaBase = z.object({
  title: TitleSchema,
...
// Fashion Listing Create Schema (ZodEffects with refinements)
export const FashionListingCreateSchema = FashionListingCreateSchemaBase
.refine(
...
// Fashion Listing Update Schema (using base for .omit() support)
export const FashionListingUpdateSchema = FashionListingCreateSchemaBase
...
// (Removed duplicate export block to avoid multiple named exports)

// Type inference helpers
export type FashionListingCreateInput = z.infer<typeof FashionListingCreateSchema>;
export type FashionListingUpdateInput = z.infer<typeof FashionListingUpdateSchema>;
export type FashionListingOutput = z.infer<typeof FashionListingSchema>;
export type FashionFiltersInput = z.infer<typeof FashionFiltersSchema>;
export type FashionSearchQueryInput = z.infer<typeof FashionSearchQuerySchema>;
