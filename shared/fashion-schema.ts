...
import { z } from "zod";
import { users } from "./schema.js"; // Import users table from main schema
...
// Export users table for compatibility with services
export { users };

// TypeScript types
export type FashionListing = typeof fashionListings.$inferSelect;
export type InsertFashionListing = z.infer<typeof insertFashionListingSchema>;
export type UpdateFashionListing = z.infer<typeof fashionListingUpdateSchema>;
export type SelectFashionListing = z.infer<typeof selectFashionListingSchema>;

export type FashionLike = typeof fashionLikes.$inferSelect;
export type InsertFashionLike = z.infer<typeof insertFashionLikeSchema>;

export type FashionComment = typeof fashionComments.$inferSelect;
export type InsertFashionComment = z.infer<typeof insertFashionCommentSchema>;

export type FashionMessage = typeof fashionMessages.$inferSelect;
export type InsertFashionMessage = z.infer<typeof insertFashionMessageSchema>;

export type FashionTransaction = typeof fashionTransactions.$inferSelect;

export type FashionAnalytics = typeof fashionAnalytics.$inferSelect;

// Fashion-specific filter types
...
// Fashion listing with additional metadata
